...
const PersonContainer = styled(Stack)(({ theme: { spacing }}) => css`
    border: 2px solid #F652A0;
    padding: ${spacing(1)};
    border-radius: 8px;
    align-items: flex-start;
    margin: ${spacing(5)} ${spacing(2)} 0 ${spacing(2)};
`)
    ...
    return(
        <Stack pb={2}>
            <PersonContainer> 
                ...
                <Typography mt={2} ml={2} variant="h6" fontSize={{xs: '1.25rem', sm: '2rem'}}>Glade kehman</Typography>
                <Typography mx={2} variant="caption" fontSize={{xs: '1rem', sm: '1.5rem'}}>
            ...
            <PersonContainer> 
                ...
                <Typography mt={2} ml={2} variant="h6" fontSize={{xs: '1.25rem', sm: '2rem'}}>Gustaf Tröttemark</Typography>
                <Typography mx={2} variant="caption" fontSize={{xs: '1rem', sm: '1.5rem'}}>
            ...
            <PersonContainer> 
                ...
                <Typography ml={2} variant="h6" fontSize={{xs: '1.25rem', sm: '2rem'}}>Super-mattsson</Typography>
                <Typography mx={2} variant="caption" fontSize={{xs: '1rem', sm: '1.5rem'}}>
            ...
            <PersonContainer> 
                ...
                <Typography ml={2} variant="h6" fontSize={{xs: '1.25rem', sm: '2rem'}}>Lasermannen</Typography>
                <Typography mx={2} variant="caption" fontSize={{xs: '1rem', sm: '1.5rem'}}>
            ...
            <PersonContainer> 
                ...
                <Typography ml={2} variant="h6" fontSize={{xs: '1.25rem', sm: '2rem'}}>Egson the silent</Typography>
                <Typography mx={2} variant="caption" fontSize={{xs: '1rem', sm: '1.5rem'}}>
            ...
            <PersonContainer> 
                ...
                <Typography ml={2} variant="h6" fontSize={{xs: '1.25rem', sm: '2rem'}} >Broderböna</Typography>
                <Typography mb={2} mx={2} variant="caption" fontSize={{xs: '1rem', sm: '1.5rem'}}>
